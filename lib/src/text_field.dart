...
class _CustomTextFieldState extends State<CustomTextField>
  ...
  TextEditingController get _effectiveController =>
      widget.controller ??
      (_controller ??= RestorableTextEditingController()).value;
  ...
  CustomKeyboardConnection get _connection =>
      _currentConnection ??= CustomKeyboardConnection(
        name: inputType.name,
  ...
  CustomTextInputType get inputType {
    if (widget.keyboardType is CustomTextInputType) {
      return widget.keyboardType as CustomTextInputType;
    }
  ...
  void didUpdateWidget(CustomTextField oldWidget) {
    ...
    _connection.controller = _effectiveController;
  ...
  void _triggerOnChanged() {
    _triggerCursor();
    widget.onChanged?.call(_connection.controller.text);
  }
  ...
  Widget build(BuildContext context) {
    return UnmanagedRestorationScope(
      bucket: bucket,
      child: TextField(
        controller: _connection.controller,
        focusNode: _effectiveFocusNode,
        decoration: widget.decoration,
        keyboardType:
            _isCustomKeyboard ? TextInputType.none : widget.keyboardType,
